...
10.
11. Run Deep Learning baseline models by executing: (PA)Project_on_50000_swn_402_.ipynb This notebook trains and evaluates: CNN, RNN, LSTM and Feed-Forward Neural Network (NN) Run the BERT fine-tuning experiment by executing: (PA)Project_on_50000_swn_128_max_8_batch,_.ipynb
12.
